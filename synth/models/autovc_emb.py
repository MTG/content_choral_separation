...
from synth.data_pipeline import autovc_emb as data_pipeline
...
class AutoVC(model.Model):
    ...
    def __init__(self):
        ...
        self.get_optimizers()
        self.get_summary(self.sess, config.autovc_emb_log_dir, summary_dict)
        self.load_model(self.sess, config.autovc_emb_log_dir)
