...
model.solo_unison_file_wav('../sep_content/Unison_analysis_examples/sol_soprano1_loc.wav')
# model = SIN.SIN()
# model.train()
# model.test_file_wav('yam_Scott_Scott_004_10.hdf5', 4)
# import pdb;pdb.set_trace()
model.test_file_wav_f0('../sep_content/Unison_analysis_examples/uni_alto_loc.wav', '../sep_content/Unison_analysis_examples_CREPE/uni_alto_loc_CREPE.f0')

# model = AutoVC.AutoVC()
# model.solo_unison_file_wav("csd_alto4_ElRossinyol_0.hdf5", 0.5, 4, 5)
